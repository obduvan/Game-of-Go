...
class Game:
    ...
    def get_removed_groups(self):
        return (
            self.validate_game_rule.removed_black_group,
            self.validate_game_rule.removed_white_group,
        )

    def validate_set_stones(self, x_mouse, y_mouse):
        return self.validate.validate_set_stones(
            x_mouse, y_mouse, self.normalize_coord_stones_dict
        )
